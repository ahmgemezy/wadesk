...
**Stack:** Next.js 15 (App Router) · Convex (backend + real-time DB) · Clerk (auth + multi-tenant orgs) · shadcn/ui · Tailwind CSS v4 · Meta WhatsApp Cloud API · Polar.sh (payments, not yet integrated)  
**Current branch:** `task/014-round-robin`  
**Build status:** ✅ No TypeScript errors · ✅ Convex schema deployed · ✅ Dev server runs · ✅ Outbound messages wired to Meta API
